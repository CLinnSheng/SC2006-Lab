...
import SortBottomSheet, { SortOptions } from "./SortBottomSheet";
...
const BottomSheetContainer = ({
  ...
  const handleSortButtonPress = () => {
    console.log("Opening sort bottom sheet");
    setShowSortSheet(true);
  };

  const handleSortClose = () => {
    console.log("Closing sort bottom sheet");
  ...
  return (
    <>
      {!showSelectedCarParkSheet && !showFilterSheet && !showSortSheet && (
        <BottomSheet
          ref={bottomSheetRef}
          index={1}
          ...
          {!isSearchFocused && combinedListCarPark.length > 0 && (
            <View style={styles.actionButtonsContainer}>
              <View style={styles.buttonsGroup}>
                ...
                <Sort onPress={handleSortButtonPress} />
              </View>
              <View>
