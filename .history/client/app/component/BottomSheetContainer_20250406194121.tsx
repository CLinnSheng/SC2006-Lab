...
const BottomSheetContainer = ({
  ...
  // Apply filters to the car park list
  const filteredCarParks = useCallback(() => {
    return combinedListCarPark.filter(carPark => {
      // Filter by distance
      ...
      if (filters.evChargingAvailable) {
        // If EV charging is required, only include EV type or CarPark with EV
        if (carPark.type !== 'EV') {
          return false;
        }
      }
